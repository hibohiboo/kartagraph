  ...
  private createCloudFront(
    ...
    const spaRoutingFunction = new cf.Function(this, 'SpaRoutingFunction', {
      ...
      function handler(event) {
        ...
        } else if (request.uri.startsWith('/cartagraph-udonarium-plus')){
          request.uri = '/cartagraph-udonarium-plus/index.html';
        ...
        } else if (request.uri.startsWith('/lily-for-gm')){
          request.uri = '/lily-for-gm/index.html';
        } else if (request.uri.startsWith('/solo-builder')){
          request.uri = '/solo-builder/index.html';
        } else {
